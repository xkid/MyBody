...
// Application Version - Bumped to 1.6.6
        ...
        {showUpdateModal && (
            <div className="fixed inset-0 z-[200] bg-black/50 backdrop-blur-sm flex items-center justify-center p-6 animate-in fade-in">
                <div className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl animate-in zoom-in-95">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Build Fixed!</h3>
                    <div className="space-y-3 text-gray-600 text-sm">
                        <p>Version {APP_VERSION} is ready.</p>
                        <p className="text-xs bg-gray-100 p-2 rounded">Resolved dependency issues.</p>
                    </div>
                    <button 
